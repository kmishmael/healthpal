        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">+20% from yesterday</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">+30% from yesterday</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">+25% from yesterday</p>
            </CardContent>
          </Card>
        </div>
        <div className="mt-8">
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-lg font-medium">Activity Chart</CardTitle>
            </CardHeader>
            <CardContent>
