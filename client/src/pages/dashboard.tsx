  ...
  return (
    <div className="p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <DashboardCard icon="💧" title="Water Intake" value={waterIntake} unit="ml" />
        <DashboardCard icon="😴" title="Sleep Time" value={sleepTime} unit="hours" />
        <DashboardCard icon="🏋️‍♂️" title="Exercises" value={exercises} unit="minutes" />
