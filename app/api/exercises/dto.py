...
exercise_allocation_reqparser = RequestParser(bundle_errors=True)
exercise_allocation_reqparser.add_argument(name="exercise_id", type=int,required=True, nullable=False)
exercise_allocation_reqparser.add_argument(name="reps", type=int,required=True, nullable=False)
exercise_allocation_reqparser.add_argument(name="sets", type=int,required=True, nullable=False)
exercise_allocation_reqparser.add_argument(name="exercises_id", type=int,required=True, nullable=False)
